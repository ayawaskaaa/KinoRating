...
public class MovieDAOImpl extends AbstractDAOImpl implements MovieDAO {
    ...
    @Override
    public boolean create(Connection con, Movie movie) throws DAOException {
    ...
    @Override
        public Movie read(Connection con, int id) throws DAOException {
        PreparedStatement stmt = null;
        ResultSet rs = null;
        Movie movie = null;
        try {
    ...
    @Override
    public ArrayList<Movie> readByPage(Connection con, int page) throws DAOException {
        PreparedStatement stmt = null;
        ResultSet rs = null;
    ...
    @Override
    public ArrayList<Movie> read(Connection con, String name) throws DAOException {
        PreparedStatement stmt = null;
        ResultSet rs = null;
